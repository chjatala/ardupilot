...
private:
    ...
    //4 was the original size, but CMH changed to AP_BEACON_MAX_BEACONS to avoid assertion error in ardupilot/libraries/AP_NavEKF3/AP_NavEKF3_Measurements.cpp
