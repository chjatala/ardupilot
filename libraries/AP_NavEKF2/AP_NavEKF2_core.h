...
private:
    ...
    //10 was the original size, but CMH changed to AP_BEACON_MAX_BEACONS to avoid assertion error in ardupilot/libraries/AP_NavEKF2/AP_NavEKF2_Measurements.cpp
